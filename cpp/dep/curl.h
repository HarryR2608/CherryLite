...
typedef enum {
  /* This is the FILE * or void * the regular out should be written to. */
  ...
  /* Function that will be called to store the out (instead of fwrite). The
  ...
  /* no out on http error codes >= 400 */
